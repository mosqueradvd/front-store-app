...
const PrivacyPolicy = () => {
  return (
    <div>
      <h1>Privacy Policy for Mi Tienda</h1>

      <p>
        At Mi Tienda, accessible from https://mi-tienda.vercel.app/, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Mi Tienda and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Mi Tienda. This policy is not applicable to any
      ...
      <p>
        Mi Tienda follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Mi Tienda uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertising partners of Mi Tienda.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Mi Tienda, which are sent
      ...
      <p>
        Note that Mi Tienda has no access to or control over these cookies that
      ...
      <p>
        Mi Tienda's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Mi Tienda does not knowingly collect any Personal Identifiable
